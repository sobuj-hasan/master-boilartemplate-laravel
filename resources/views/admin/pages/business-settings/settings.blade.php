...
@section('title')
    Text to Speech | Business Settings
@endsection
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="basic-example">
                                    ...
                                    <form action="{{ route('settings.update', ['type' => 'general_settings']) }}"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <img class="mb-2" src="{{ asset('storage/images/'.$businessSettings->favicon) }}" height="48" alt="">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <img class="mb-1" src="{{ asset('storage/images/'.$businessSettings->logo) }}" height="50" alt="">
                                        ...
                                        <div class="row">
                                            @if ($admin->can('Settings Update Button'))
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <button style="margin-top: 15px;" class="btn btn-success"
                                                            type="submit"> <i class="uil uil-file-alt"></i> Save Changes</button>
                                                    </div>
                                                </div>
                                            @endif
                                            <div class="col-lg-6 ">
                                ...
                                <!-- social setting -->
                                <h3 class="my-3">Company Social Page</h3>
                                <section>
                                ...
                                <!-- mail settings -->
                                <h3 class="my-3">Mail Configaration</h3>
                                <section>
                                    <div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="mail_password"
                                                            value="{{ $businessSettings->mail_password }}" type="password"
                                                            class="form-control" id="basicpill-cstno-input"
                                ...
                                <h3 class="my-3">Payment Getway</h3>
                                <section>
                                    <div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                ...
                                <h3 class="my-3">Dashboard Button Selection</h3>
                                <section>
