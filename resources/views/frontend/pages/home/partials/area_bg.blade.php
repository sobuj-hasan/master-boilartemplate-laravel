<div class="area-bg" data-background="{{ asset('frontend') }}/assets/img/bg/area_bg.jpg">
    <!-- pricing-area -->
    <section class="pricing-area-two">
        ...
        <div class="pricing-item-wrap-two">
            ...
            <div class="col-lg-4 col-md-6">
                <div
                class="pricing-item-two wow fadeInLeft"
                data-wow-delay=".2s"
                >
            ...
            <div class="col-lg-4 col-md-6">
                <div
                class="pricing-item-two active wow fadeInUp"
                data-wow-delay=".4s"
                >
                <div class="pricing-shape">
                    <svg
                ...
                <div class="pricing-btn">
                    <a
                    href="login.html"
                    class="gradient-btn gradient-btn-three"
                    >choose plan</a
                    >
                </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div
                class="pricing-item-two wow fadeInRight"
                data-wow-delay=".2s"
                >
                <div class="sticker">
                    <img src="{{ asset('frontend') }}/assets/img/images/sticker.png" alt="" />
                </div>
                <div class="pricing-shape">
                    <svg
                    viewBox="0 0 410 610"
        ...
        <img
            src="{{ asset('frontend') }}/assets/img/images/pricing_shape.png"
            alt=""
    ...
    <section class="counter-area-two pt-110">
        ...
        <div class="row">
            ...
            <div class="counter-wrap">
                ...
                <div class="col-lg-8">
                    ...
                    data-background="{{ asset('frontend') }}/assets/img/images/h2_counter_shape.png"
                    >
                    <h6 class="title">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="certificate-active">
                        ...
                        <img
                            src="{{ asset('frontend') }}/assets/img/images/certificate01.png"
                            alt=""
                        />
                        </div>
                        <div class="certificate-item">
                        <img
                            src="{{ asset('frontend') }}/assets/img/images/certificate02.png"
                            alt=""
                        />
                        </div>
                        <div class="certificate-item">
                        <img
                            src="{{ asset('frontend') }}/assets/img/images/certificate03.png"
                            alt=""
                        />
                        </div>
                    </div>
        ...
        <img
            src="{{ asset('frontend') }}/assets/img/images/counter_shape.png"
            alt=""
            data-aos="fade-left"
            data-aos-delay="300"
        />
