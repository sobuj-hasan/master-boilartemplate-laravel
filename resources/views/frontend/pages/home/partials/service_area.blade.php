<section class="services-area pb-110">
    ...
    <div class="row">
        ...
        <div class="services-tab-wrap">
            ...
            <li class="nav-item" role="presentation">
                ...
                data-bs-toggle="tab"
                data-bs-target="#communications-tab-pane"
                type="button"
                role="tab"
                aria-controls="communications-tab-pane"
                aria-selected="false"
                >
                <svg
                    viewBox="0 0 25 20"
            ...
            <li class="nav-item" role="presentation">
                ...
                id="localization-tab"
                data-bs-toggle="tab"
                data-bs-target="#localization-tab-pane"
                type="button"
                role="tab"
                aria-controls="localization-tab-pane"
                aria-selected="false"
                >
                <svg
                    viewBox="0 0 16 22"
            ...
            <li class="nav-item" role="presentation">
                <button
                class="nav-link"
                id="advertisement-tab"
                data-bs-toggle="tab"
                data-bs-target="#advertisement-tab-pane"
                type="button"
                role="tab"
                aria-controls="advertisement-tab-pane"
                aria-selected="false"
                >
                <svg
                    viewBox="0 0 20 20"
            ...
            >
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <img
                        src="{{ asset('frontend') }}/assets/img/services/services_img01.jpg"
                        alt=""
                    />
                    <a
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="services-item">
                    <img
                        src="{{ asset('frontend') }}/assets/img/services/services_img02.jpg"
                        alt=""
                    />
                    <a
                        href="http://www.youtube.com/watch?v=1iIZeIy7TqM"
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="services-item">
                    <img
                        src="{{ asset('frontend') }}/assets/img/services/services_img03.jpg"
                        alt=""
                    />
                    <a
                        href="http://www.youtube.com/watch?v=1iIZeIy7TqM"
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="services-item">
                    <img
                        src="{{ asset('frontend') }}/assets/img/services/services_img04.jpg"
                        alt=""
                    />
                    <a
                        href="http://www.youtube.com/watch?v=1iIZeIy7TqM"
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="services-item">
                    <img
                        src="{{ asset('frontend') }}/assets/img/services/services_img05.jpg"
                        alt=""
                    />
                    <a
                        href="http://www.youtube.com/watch?v=1iIZeIy7TqM"
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="services-item">
                    <img
                        src="{{ asset('frontend') }}/assets/img/services/services_img06.jpg"
                        alt=""
                    />
                    <a
                        href="http://www.youtube.com/watch?v=1iIZeIy7TqM"
    ...
    <img
        src="{{ asset('frontend') }}/assets/img/images/services_shape01.png"
        alt=""
        data-aos="fade-left"
        data-aos-delay="300"
    />
    <img
        src="{{ asset('frontend') }}/assets/img/images/services_shape02.png"
        alt=""
        data-aos="fade-right"
        data-aos-delay="300"
    />
