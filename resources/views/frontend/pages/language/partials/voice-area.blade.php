<section class="services-area pt-80 pb-120">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-9 col-lg-10">
          <div
            class="section-title-three text-center mb-60 title-animation"
          >
            <h2 class="title">
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button
                  ...
                  id="promotional-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#promotional-tab-pane"
                  type="button"
                  role="tab"
                  aria-controls="promotional-tab-pane"
                  aria-selected="false"
                >
                  <svg
                    viewBox="0 0 25 21"
              ...
              <li class="nav-item" role="presentation">
                <button
                  ...
                  id="learning-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#learning-tab-pane"
                  type="button"
                  role="tab"
                  aria-controls="learning-tab-pane"
                  aria-selected="false"
                >
                  <svg
                    viewBox="0 0 20 21"
              ...
              <li class="nav-item" role="presentation">
                <button
                  ...
                  id="explainer-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#explainer-tab-pane"
                  type="button"
                  role="tab"
                  aria-controls="explainer-tab-pane"
                  aria-selected="false"
                >
                  <svg
                    viewBox="0 0 20 21"
              ...
              <li class="nav-item" role="presentation">
                <button
                  ...
                  id="podcasts-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#podcasts-tab-pane"
                  type="button"
                  role="tab"
                  aria-controls="podcasts-tab-pane"
                  aria-selected="false"
                >
                  <svg
                    viewBox="0 0 21 21"
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="row justify-content-center">
                  <div class="col-lg-4 col-md-6 col-sm-10 my-2">
                    <div class="vioces-item">
                      <div class="vioces-thumb">
                        <img
                          src="{{ asset('frontend/assets/img/images/voice_img01.jpg') }}"
                          alt=""
                        />
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-10 my-2">
                    <div class="vioces-item">
                      <div class="vioces-thumb">
                        <img
                          src="{{ asset('frontend/assets/img/images/voice_img02.jpg') }}"
                          alt=""
                        />
                      </div>
                      <div class="vioces-content">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-10 my-2">
                    <div class="vioces-item">
                      <div class="vioces-thumb">
                        <img
                          src="{{ asset('frontend/assets/img/images/voice_img03.jpg') }}"
                          alt=""
                        />
                      </div>
                      <div class="vioces-content">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-10 my-2">
                    <div class="vioces-item">
                      <div class="vioces-thumb">
                        <img
                          src="{{ asset('frontend/assets/img/images/voice_img04.jpg') }}"
                          alt=""
                        />
                      </div>
                      <div class="vioces-content">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-10 my-2">
                    <div class="vioces-item">
                      <div class="vioces-thumb">
                        <img
                          src="{{ asset('frontend/assets/img/images/voice_img05.jpg') }}"
                          alt=""
                        />
                      </div>
                      <div class="vioces-content">
                    ...
                    <div class="more-vioces-item">
                      <div class="more-vioces-thumb">
                        <ul class="list-wrap">
                          <li>
                            <img
                              src="{{ asset('frontend/assets/img/images/m_voice_img01.png') }}"
                              alt=""
                            />
                          </li>
                          <li>
                            <img
                              src="{{ asset('frontend/assets/img/images/m_voice_img02.png') }}"
                              alt=""
                            />
                          </li>
                          <li>
                            <img
                              src="{{ asset('frontend/assets/img/images/m_voice_img03.png') }}"
                              alt=""
                            />
                          </li>
                          <li>
                            <img
                              src="{{ asset('frontend/assets/img/images/m_voice_img04.png') }}"
                              alt=""
                            />
                          </li>
                          <li>
                            <img
                              src="{{ asset('frontend/assets/img/images/m_voice_img05.png') }}"
                              alt=""
                            />
                          </li>
                        </ul>
                      ...
                      <div class="more-vioces-content">
                        ...
                        <a
                          href="login.html"
                          class="gradient-btn gradient-btn-two"
                          >TRY NOW FOR FREE</a
                        >
                      </div>
                    </div>
              ...
              <div
                class="tab-pane fade"
                id="explainer-tab-pane"
                role="tabpanel"
                aria-labelledby="explainer-tab"
                tabindex="0"
              >
                <div class="row justify-content-center">
                  <div class="col-lg-4 col-md-6 col-sm-10 my-2">
    ...
    <div class="vioces-shape">
      <img
        src="{{ asset('frontend/assets/img/images/voice_shape.png') }}"
        alt=""
